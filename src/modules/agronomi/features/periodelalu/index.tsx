...
const PASPeriodeLalu = () => {
    ...
    // Load data list PAS Lalu
    function loadData() {
        const PeriodeLaluList = getDataPeriode("LALU").then(function (response) {
            if (response.statusCode === 200) {
                setDataPASLalu(response.result);
                loadjs();
            }
        })
    }

    console.log(dataPasLalu);
            ...
            <div>
                <div className="row wrapper border-bottom white-bg page-heading">
                    <div className="col-lg-10">
                        <h2>Masalah dan Alt. Solusi Periode Lalu</h2>
                    </div>
                </div>
                        ...
                        <div className="col-lg-12">
                            <div className="ibox ">
                                <div className="ibox-title bg-primary">
                                    <h5>List Masalah dan Alt. Solusi Periode Lalu</h5>
